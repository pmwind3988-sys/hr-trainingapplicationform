  ...
  pages: [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          // Optional: Change the header text of the number column (default is #)
          ...
          "columns": [
            ...
            },
            {
              ...
              // This is the magic property that limits selection
            ...
            {
              "name": "how_know_achieve_goal",
              "title": "How will you know you've achieve your goal?",
              "cellType": "comment",
              isRequired : false
            },
            {
              "name": "relevance_to_job_function",
              "title": "Please state relevance to the job function",
              "cellType": "comment",
              isRequired : false
            },
            {
        ...
        },
        {
          ...
          elements: [
            {
              type: "text", name: "hod_name", title: "Name of HOD",
              isRequired: true, startWithNewLine: false
            },
            {
              type: "text", name: "hod_designation", title: "Designation",
              isRequired: true, startWithNewLine: false
            },
            {
              type: "signaturepad",
